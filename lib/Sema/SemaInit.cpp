...
QualType Sema::DeduceClassTemplateSpecializationFromInitializer(
...
QualType Sema::DeduceTypeAliasTemplateSpecializationFromInitializer(
...
QualType Sema::DeduceTemplateSpecializationFromInitializer(
  ...
  if (ClassTemplate)
    DeduceClassTemplateSpecializationFromInitializer(
        ClassTemplate, TemplateName, TSInfo, Entity, Kind, Inits);

  auto *AliasTemplate =
      dyn_cast_or_null<TypeAliasTemplateDecl>(TemplateName.getAsTemplateDecl());
  if (AliasTemplate)
    DeduceTypeAliasTemplateSpecializationFromInitializer(
        AliasTemplate, TemplateName, TSInfo, Entity, Kind, Inits);
